import { StyledIconContainer } from './styledElements';
  ...
  return (
    <StyledIconContainer>
      <svg
        ...
        height='1em'
        fill={color}
        viewBox='0 0 29.242 29.242'
        className='svgIcon facebookSVG'
      >
        <g id='c69_facebook'>
          <path
            d='M26.918,0.668H2.326C1.039,0.668,0,1.707,0,2.992v23.259c0,1.282,1.039,2.323,2.326,2.323h24.592
